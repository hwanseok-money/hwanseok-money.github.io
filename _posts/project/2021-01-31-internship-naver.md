...
3. 새로운 분야 : c++ 기반 멀티 쓰레드 구조의 서버를 직접 설계했습니다. 서버 설계에 대한 경험이 없었지만, 기존의 RTMP Relay Server는 다양한 요구사항에 대응하는데 한계가 있었기 때문에 변화가 필요했습니다.  설계 뿐만 아니라 Protocol 기반의 개발과 서버의 성능 측정 부분도 낯분.였습니다. 
