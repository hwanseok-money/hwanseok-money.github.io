...
[여기][1]에 따르면 django-admin으로 생성된 프로젝트는 `APP_DIRS`가 true로 생성되어서 app 하위의 template 디렉토리에서 template 문서를 찾습니다. 
...
지금 상황에서는 두 번째 attribute look up으로 사용됩니다. template를 구성하는 자세한 방법은 [여기][2]있습니다. 추후 더 알아보겠습니다.  
...
[1]: https://docs.djangoproject.com/en/3.1/ref/settings/#app-dirs
[2]: https://docs.djangoproject.com/en/3.1/topics/templates/